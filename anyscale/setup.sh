...
echo ""
echo "Submit a job:"
echo "  anyscale job submit --cloud ${ANYSCALE_CLOUD_NAME} \\"
echo "    --working-dir https://github.com/anyscale/docs_examples/archive/refs/heads/main.zip \\"
echo "    -- python hello_world.py"
echo ""
echo "Run a tutorial:"
echo "  ./tutorials/llm-batch-inference/submit.sh"
